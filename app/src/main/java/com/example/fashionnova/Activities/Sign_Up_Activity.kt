...
import com.example.fashionnova.databinding.ActivitySignUpBinding
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQ_ONE_TAP && data != null) {
            try {
                    ...
                    auth.signInWithCredential(firebaseCredential)
                        .addOnCompleteListener(this) { task ->
                            if (task.isSuccessful) {
                                ...
                                // Authentication failed, log the exception message
                                ...
                                if (exception != null) {
                                    ...
                                    Log.e("SignInError", "Authentication failed", exception)
                                } else {
                ...
                Log.e("SignInError", "Unexpected error", e)
            }
        }
    }
